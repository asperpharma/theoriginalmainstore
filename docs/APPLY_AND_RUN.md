...
**Single source:** [BRAIN-CONFIG.md](./BRAIN-CONFIG.md) (Brain `mpcxpydkzvwlflxcujnz`)  
...
From [BRAIN-CONFIG.md](./BRAIN-CONFIG.md). All POST to Brain **mpcxpydkzvwlflxcujnz**; responses and links should reference the main site.
...
| **Bulk upload** | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/bulk-product-upload` |
| **Health check** | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/beauty-assistant?health=true` |
