...
**Enforced Brain ID:** `mpcxpydkzvwlflxcujnz`  
...
Store them only in **Supabase Dashboard** â†’ Project **mpcxpydkzvwlflxcujnz** â†’ **Project Settings** â†’ **Edge Functions** â†’ **Secrets**.
...
- **Direct DB (PostgreSQL):**  
  `postgresql://postgres:[YOUR-PASSWORD]@db.mpcxpydkzvwlflxcujnz.supabase.co:5432/postgres`  
  Use your project DB password from Supabase Dashboard.

- **Supabase Auth callback (e.g. Cursor OAuth):**  
  `https://mpcxpydkzvwlflxcujnz.supabase.co/auth/v1/callback`
...
All endpoints use Brain **mpcxpydkzvwlflxcujnz**. POST only.

| Use | URL |
|-----|-----|
| Gorgias (Unified Helpdesk) | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/beauty-assistant?route=gorgias` |
| ManyChat (WhatsApp & Instagram) | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/beauty-assistant?route=manychat` |
| Bulk Inventory Uploader | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/bulk-product-upload` |
| Frontend / Brain health check | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/beauty-assistant?health=true` |
