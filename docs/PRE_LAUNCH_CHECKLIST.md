...
> **See also:** [MASTER_LAUNCH_CHECKLIST.md](./MASTER_LAUNCH_CHECKLIST.md) — covers payments, shipping, theme audit, legal pages, and the live test-order protocol.
...
> **Next:** Once all infrastructure items above are green, move to [MASTER_LAUNCH_CHECKLIST.md](./MASTER_LAUNCH_CHECKLIST.md) for payments, shipping, theme, and live-order verification.
