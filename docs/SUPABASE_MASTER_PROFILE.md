...
> **Active Project ID:** `mpcxpydkzvwlflxcujnz`
...
| Project ID (production) | `mpcxpydkzvwlflxcujnz` |
| Project base URL | `https://mpcxpydkzvwlflxcujnz.supabase.co` |
| Dashboard | `https://supabase.com/dashboard/project/mpcxpydkzvwlflxcujnz` |
| GitHub repository | `asperpharma/understand-project` |
| Primary branch | `main` |

**Deprecated IDs:** `rgehleqcubtmcwyipyvi` (original) and `vhgwvfedgfmcixhdyttt` (previous) — do NOT use. All references must point to `mpcxpydkzvwlflxcujnz`.
...
- **Production:** `mpcxpydkzvwlflxcujnz`
...
| Working Branch | `main` |
| Backend Brain | `https://mpcxpydkzvwlflxcujnz.supabase.co/functions/v1/beauty-assistant` |
