...
/**
 * Production E2E tests for critical Asper Beauty Shop user journeys.
 * Runs only when E2E_BASE_URL is explicitly provided.
 *
 * Flows covered:
...
const BASE = process.env.E2E_BASE_URL || "https://asperbeautyshop.com";

test.skip(!process.env.E2E_BASE_URL, "Set E2E_BASE_URL to run production E2E flows.");
