...
// Global error telemetry — captures unhandled JS errors and promise rejections
function useGlobalErrorTelemetry() {
  useEffect(() => {
    const onError = (e: ErrorEvent) => logClientError(e.error ?? e.message, "window.onerror");
    const onUnhandled = (e: PromiseRejectionEvent) => logClientError(e.reason, "unhandledrejection");
