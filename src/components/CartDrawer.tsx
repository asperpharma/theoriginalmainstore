            ...
            <>
              {items.length === 0 ? (
                ...
                <>
                  ...
                  <div
                    className="flex-shrink-0 p-5 sm:p-8"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <button
                        ...
                        className="w-full min-h-[48px] px-3 py-4 font-body text-[11px] sm:text-xs font-semibold uppercase tracking-[0.12em] sm:tracking-[0.2em] text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 rounded-sm shadow-md bg-burgundy hover:bg-burgundy-dark hover:scale-[1.01]"
                      >
                      ...
                      <button
                        ...
                        disabled={items.length === 0 || isLoading}
                        className="w-full min-h-[44px] px-3 py-3 font-body text-[11px] sm:text-xs font-semibold uppercase tracking-[0.1em] sm:tracking-[0.15em] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 rounded-sm border-2 border-burgundy text-burgundy bg-transparent hover:bg-burgundy hover:text-white"
                      >
