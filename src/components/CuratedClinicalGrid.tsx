    ...
    >
      ...
      <div className="mt-auto">
        ...
        <button
          ...
          className="w-full py-3 bg-[#800020] text-white font-montserrat font-semibold text-sm rounded transition-all duration-[400ms] group-hover:bg-[#5a0016] active:scale-[0.98]"
        >
