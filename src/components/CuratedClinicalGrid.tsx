  ...
  return (
        <article
                className={cn(
                          ...
                          "neu-raised relative flex flex-col h-full overflow-hidden rounded-xl p-4 md:p-5 z-10 group",
                          // Glassmorphism engine
                          "bg-[#F8F8FF]/60 border border-[#C5A028]/30",
                          "backdrop-blur-sm md:backdrop-blur-md",
                          // Transition — use named token instead of arbitrary [400ms]
              ...
              <div className="mt-auto">
                ...
                {/* Quick Add button */}
                      <button
                                  ...
                                  className="w-full py-3 bg-[#800020] text-white font-montserrat font-semibold text-sm rounded transition-all duration-400 group-hover:bg-[#5a0016] active:scale-[0.98]"
                                >
...
export function CuratedClinicalGrid({
    ...
    return (
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8">
        {/* Section header */}
        <h2 className={cn(
          "section-header font-playfair text-[#800020] text-3xl md:text-4xl font-bold text-center mb-10 tracking-tight",
          isAr && "font-arabic"
        )}>
