...
function ProductTile({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "neu-raised group relative overflow-hidden bg-polished-white border border-transparent",
        "hover:border-shiny-gold transition-all duration-500",
      ...
      <Link to={`/product/${product.handle}`} className="block">
        <div className={cn(
          ...
          <BlurUpImage
            ...
            alt={product.title}
            className="w-full h-full object-cover transition-transform duration-700 ease-luxury-out group-hover:scale-105"
          />
    ...
    <section className="py-20 md:py-28 bg-soft-ivory">
      <div className="luxury-container">
        ...
        >
          ...
          <h2 className="section-header font-display text-4xl md:text-5xl text-dark-charcoal mb-5">
            ...
            {categories.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  activeCategory === cat
                    ? "neu-inset bg-burgundy border-burgundy text-white"
                    : "neu-flat bg-transparent border-border/50 text-muted-foreground hover:border-polished-gold hover:text-dark-charcoal"
                )}
              >
                {cat}
              </button>
