...
const socialIconClass = "w-10 h-10 rounded-full border border-polished-gold flex items-center justify-center text-polished-gold hover:bg-polished-gold hover:border-polished-gold hover:text-burgundy transition-all duration-300";
...
export const Footer = () => {
  ...
  const conciergLinks = [
    ...
    { name: isArabic ? "سياسة الشحن" : "Shipping Policy", href: "/terms" },
    { name: isArabic ? "الإرجاع والاستبدال" : "Returns & Exchanges", href: "/terms" },
    { name: isArabic ? "استشارة البشرة" : "Skin Consultation", href: "/skin-concerns" },
  ];

  const aboutLinks = [
    { name: isArabic ? "فلسفتنا" : "Our Philosophy", href: "/philosophy" },
    { name: isArabic ? "الأم والطفل" : "Mom & Baby", href: "/mom-baby" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="font-body text-sm text-asper-stone-light hover:text-polished-gold transition-colors duration-300 text-left"
                >
              ...
              {conciergLinks.map((item, index) => (
                <li key={`${item.href}-${index}`}>
                  <Link to={item.href} className="font-body text-sm text-asper-stone-light hover:text-polished-gold transition-colors duration-300">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="tel:+962790656666" className="font-body text-sm text-asper-stone-light hover:text-polished-gold transition-colors duration-300 block">
                +962 79 065 6666
              </a>
              <a href="mailto:asperpharma@gmail.com" className="font-body text-sm text-asper-stone-light hover:text-polished-gold transition-colors duration-300 block">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-3 bg-transparent border border-polished-white/40 text-polished-white font-body text-sm placeholder:text-polished-white/50 focus:outline-none focus:border-polished-gold transition-colors duration-300 rounded"
              />
              <button
                type="submit"
                className="w-full px-6 py-3 bg-polished-gold text-burgundy font-display text-sm tracking-wider hover:bg-polished-gold/80 transition-colors rounded"
              >
                {submitted
        ...
        <div className="luxury-container py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1.5">
                {[
                  { en: "Skincare", ar: "العناية بالبشرة", href: "/collections/skincare" },
                  { en: "Makeup", ar: "المكياج", href: "/collections/makeup" },
                  { en: "Perfume", ar: "العطور", href: "/collections/perfume" },
                  { en: "Hair Care", ar: "العناية بالشعر", href: "/collections/hair" },
                  { en: "Body Care", ar: "العناية بالجسم", href: "/collections/body" },
                  { en: "Sun Protection", ar: "الحماية من الشمس", href: "/collections/suncare" },
                  { en: "Anti-Aging", ar: "مكافحة الشيخوخة", href: "/concerns/anti-aging" },
                  { en: "Acne Treatment", ar: "علاج حب الشباب", href: "/concerns/acne" },
                  { en: "Moisturizers", ar: "المرطبات", href: "/collections/moisturizers" },
                  { en: "Serums", ar: "السيرومات", href: "/collections/serums" },
                ].map((cat) => (
                  <Link
                    key={cat.en}
                    to={cat.href}
        ...
        <div className="luxury-container py-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="/privacy" className="font-body text-xs text-asper-stone-light/40 hover:text-polished-gold transition-colors">
                {isArabic ? "سياسة الخصوصية" : "Privacy Policy"}
              </Link>
              <span className="text-asper-stone-light/20">·</span>
              <Link to="/terms" className="font-body text-xs text-asper-stone-light/40 hover:text-polished-gold transition-colors">
                {isArabic ? "الشروط والأحكام" : "Terms of Service"}
              </Link>
              <span className="text-asper-stone-light/20">·</span>
              <Link to="/contact" className="font-body text-xs text-asper-stone-light/40 hover:text-polished-gold transition-colors">
