...
const socialIconClass = "w-10 h-10 rounded-full border border-polished-gold/30 flex items-center justify-center text-polished-gold cursor-pointer transition-all duration-200 shadow-[4px_4px_8px_rgba(0,0,0,0.25),-3px_-3px_6px_rgba(255,255,255,0.03)] hover:shadow-[inset_3px_3px_6px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)] hover:text-white";
      ...
      <div className="border-t border-polished-gold/30">
        <div className="luxury-container py-8">
          ...
          <div className="flex justify-center my-8">
            <div className="w-20 h-20 rounded-full border-2 border-polished-gold/60 p-1.5 shadow-[0_0_20px_rgba(197,160,40,0.15)] hover:scale-105 transition-transform duration-400 ease-luxury cursor-default">
              <svg
                viewBox="0 0 200 200"
