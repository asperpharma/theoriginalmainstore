...
const megaMenus = {
  brands: [
    { name: "Vichy", href: "/brands/vichy", label: "Dermocosmetic", labelAr: "ديرموكوزمتيك" },
    { name: "La Roche-Posay", href: "/brands/laroche", label: "Dermocosmetic", labelAr: "ديرموكوزمتيك" },
    { name: "CeraVe", href: "/brands/cerave", label: "Daily Care", labelAr: "العناية اليومية" },
    { name: "Maybelline", href: "/brands/maybelline", label: "Makeup", labelAr: "مكياج" },
    { name: "L'Oréal Paris", href: "/brands/loreal", label: "Hair & Skin", labelAr: "شعر وبشرة" },
    { name: "Garnier", href: "/brands/garnier", label: "Natural", labelAr: "طبيعي" },
  ],
  concerns: [
    { name: "Acne & Blemishes", ar: "حب الشباب والبقع", href: "/concerns/acne", icon: "✨" },
    { name: "Anti-Aging & Wrinkles", ar: "مكافحة الشيخوخة والتجاعيد", href: "/concerns/anti-aging", icon: "⏳" },
    { name: "Dryness & Hydration", ar: "الجفاف والترطيب", href: "/concerns/dryness", icon: "💧" },
    { name: "Sensitivity & Redness", ar: "الحساسية والاحمرار", href: "/concerns/sensitivity", icon: "🛡️" },
    { name: "Pigmentation", ar: "تصبغات البشرة", href: "/concerns/pigmentation", icon: "☀️" },
    { name: "Hair Loss", ar: "تساقط الشعر", href: "/concerns/hair-loss", icon: "💆‍♀️" },
  ],
};
...
export const Header = () => {
  ...
  const closeMegaMenu = () => {
    megaMenuTimeout.current = setTimeout(() => setActiveMegaMenu(null), 180);
  };
  ...
  return (
    <header className={cn("fixed top-0 z-50 w-full", isHomepage && "")}>
      {/* 1. TOP ANNOUNCEMENT BAR */}
        ...
        {language === "ar" 
          ? "توصيل مجاني للطلبات فوق 50 دينار · جمال بإشراف صيدلاني" 
          : "Free Delivery on Orders Over 50 JD · Pharmacist-Curated Beauty"}
      </div>
            ...
            <div className="flex-1 flex items-center justify-start gap-2 md:gap-4">
              ...
              <nav className="hidden lg:flex items-center gap-8 h-full">
                ...
                <div
                  ...
                  onMouseEnter={() => openMegaMenu("brands")}
                  onMouseLeave={closeMegaMenu}
                >
                  <Link
                    to="/brands"
                    aria-expanded={activeMegaMenu === "brands"}
                    aria-haspopup="true"
                    className={cn(
                      ...
                      {megaMenus.brands.map((brand) => (
                        ...
                        >
                          ...
                          <span className="text-xs text-muted-foreground uppercase tracking-wider">
                            {language === "ar" ? brand.labelAr : brand.label}
                          </span>
                        </Link>
                      ))}
                ...
                <div
                  className="group relative h-full flex items-center"
                  onMouseEnter={() => openMegaMenu("concerns")}
                  onMouseLeave={closeMegaMenu}
                >
                  <Link
                    to="/skin-concerns"
                    aria-expanded={activeMegaMenu === "concerns"}
                    aria-haspopup="true"
                    className={cn(
                      "flex items-center gap-1 font-body text-sm font-medium transition-colors py-8",
                      textColor, textColorHover
                    ...
                    <div className="absolute top-full left-0 min-w-[320px] w-[500px] bg-polished-white shadow-xl border-t-2 border-polished-gold p-6 grid grid-cols-1 gap-2 animate-fade-in rounded-b-sm z-50">
                      ...
                      {megaMenus.concerns.map((concern) => (
                        ...
                        >
                          ...
                          <span className="font-display font-medium text-burgundy group-hover/item:text-polished-gold">
                            {language === "ar" ? concern.ar : concern.name}
                          </span>
                        </Link>
                      ))}
                ...
                >
                  {language === "ar" ? "بروتوكول العناية" : "Regimens"}
                </Link>
                <Link
                  to="/offers"
                  className={cn(
            ...
            <div className="flex-1 flex items-center justify-end gap-2 md:gap-4">
              ...
              >
                ...
                <input
                  ...
                  placeholder={language === "ar" ? "ابحث في آلاف المنتجات..." : "Search 6,500+ products..."}
                  className={cn(
        ...
        <div className="md:hidden border-t border-rose-clay-light/30 bg-polished-white p-3">
          <div className="relative">
            <input
              ...
              placeholder={language === "ar" ? "ابحث في المنتجات..." : "Search 6,500+ products..."}
