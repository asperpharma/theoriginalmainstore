...
export const MobileNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-polished-white/90 backdrop-blur-lg border-t border-gold/10 py-3 px-6 flex justify-between items-center lg:hidden shadow-[0_-4px_16px_rgba(0,0,0,0.06),0_-1px_4px_rgba(255,255,255,0.8)] rounded-t-2xl">
      <Link
        to="/"
