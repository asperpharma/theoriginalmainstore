    ...
    >
      ...
      <div className="luxury-container relative">
        <AnimatedSection className="max-w-2xl mx-auto text-center">
          {/* Icon Badge */}
          <div className="neu-raised inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-gold/20 via-gold/10 to-transparent border-2 border-gold/40 mb-6 transition-shadow duration-500">
