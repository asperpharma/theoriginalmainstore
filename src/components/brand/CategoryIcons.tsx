...
/** Full category list for navigation — keys map to primary_pillar values in DB */
export const categoryList = [
  { key: "Skincare",              label: "Skincare",         labelAr: "العناية بالبشرة",  Icon: IconCatSkincare,     href: "/shop?section=Skincare" },
  { key: "Beauty & Cosmetics",    label: "Beauty",           labelAr: "الجمال",           Icon: IconCatBeauty,       href: "/shop?section=Beauty+%26+Cosmetics" },
  { key: "Haircare",              label: "Haircare",         labelAr: "العناية بالشعر",   Icon: IconCatPersonalCare, href: "/shop?section=Haircare" },
  { key: "Baby & Mom",            label: "Baby & Mom",       labelAr: "الأم والطفل",      Icon: IconCatMomBaby,      href: "/shop?section=Baby+%26+Mom" },
  { key: "Personal Care",         label: "Personal Care",    labelAr: "العناية الشخصية",  Icon: IconCatWellness,     href: "/shop?section=Personal+Care" },
  { key: "Supplements & Vitamins",label: "Vitamins",         labelAr: "فيتامينات",        Icon: IconCatVitamins,     href: "/shop?section=Supplements+%26+Vitamins" },
  { key: "Pharmacy & Wellness",   label: "Pharmacy",         labelAr: "الصيدلية",         Icon: IconCatPrescriptions,href: "/shop?section=Pharmacy+%26+Wellness" },
  { key: "Oral Care",             label: "Oral Care",        labelAr: "العناية بالفم",    Icon: IconCatOralCare,     href: "/shop?section=Oral+Care" },
  { key: "first-aid",             label: "First Aid",        labelAr: "إسعافات أولية",   Icon: IconCatFirstAid,     href: "/shop?section=Pharmacy+%26+Wellness" },
  { key: "mens-health",           label: "Men's Health",     labelAr: "صحة الرجل",        Icon: IconCatMensHealth,   href: "/shop?section=Personal+Care" },
] as const;
