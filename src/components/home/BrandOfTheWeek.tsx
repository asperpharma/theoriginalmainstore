        ...
        <AnimatedSection animation="fade-up">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className={cn("order-2 lg:order-1", isArabic && "text-right")}>
              ...
              <h2 className={cn(
                "section-header font-heading text-3xl lg:text-4xl xl:text-5xl font-bold text-asper-ink mb-3 leading-tight",
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <div key={pillar.en} className="neu-raised text-center p-3 border border-polished-gold/20 rounded-lg bg-polished-gold/5">
              ...
              <Link to="/brands/vichy">
                <Button size="lg" className="luxury-button-primary group text-sm uppercase tracking-widest px-8 h-12 font-semibold transition-all duration-400">
            ...
            <div className="order-1 lg:order-2">
              <div className="neu-raised relative rounded-2xl overflow-hidden aspect-square lg:aspect-[4/5] bg-white p-8">
