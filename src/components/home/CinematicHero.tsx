...
function EditorialCard({
  ...
  return (
    ...
    >
      {/* Card — neumorphic raised on dark */}
      <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[10px_10px_20px_rgba(0,0,0,0.5),-6px_-6px_16px_rgba(255,255,255,0.04)]">
        <img
          src={image.src}
          alt={image.alt}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              className={cn(
                ...
                "border border-polished-gold/30 bg-polished-gold/8 backdrop-blur-md",
                "text-polished-gold text-[10px] uppercase tracking-[0.35em] font-body",
                "shadow-[4px_4px_10px_rgba(0,0,0,0.25),-3px_-3px_8px_rgba(255,255,255,0.04)]",
          ...
          >
            {/* Primary CTA — Neumorphic raised */}
            <Link
              to="/shop"
              className={cn(
                "group inline-flex items-center gap-2.5 px-10 py-5 rounded-xl cursor-pointer",
                "bg-burgundy text-white",
                "font-body text-[12px] uppercase tracking-[0.3em] font-semibold",
                "transition-all duration-200",
                "shadow-[6px_6px_14px_rgba(128,0,32,0.5),-4px_-4px_10px_rgba(255,255,255,0.08)]",
                "hover:shadow-[8px_8px_18px_rgba(128,0,32,0.6),-6px_-6px_14px_rgba(255,255,255,0.1)]",
            ...
            {/* Ghost CTA — Neumorphic flat */}
            <Link
              to="/skin-concerns"
              className={cn(
                "inline-flex items-center gap-2 px-10 py-5 rounded-xl cursor-pointer",
                "bg-white/5 backdrop-blur-md border border-white/15 text-white/80",
                "font-body text-[12px] uppercase tracking-[0.3em]",
                "transition-all duration-200",
                "shadow-[4px_4px_10px_rgba(0,0,0,0.3),-3px_-3px_8px_rgba(255,255,255,0.05)]",
                "hover:shadow-[6px_6px_14px_rgba(0,0,0,0.4),-4px_-4px_10px_rgba(255,255,255,0.08)]",
                "hover:border-polished-gold/40 hover:text-white",
                "hover:translate-y-[-2px]",
                "active:shadow-[inset_3px_3px_6px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)]",
                "active:translate-y-0",
                isAr && "flex-row-reverse"
              )}
            >
          ...
          >
            <div
              className={cn(
                "grid grid-cols-3 gap-4 p-5 rounded-2xl",
                "bg-white/[0.03] backdrop-blur-sm",
                "shadow-[inset_4px_4px_10px_rgba(0,0,0,0.3),inset_-3px_-3px_8px_rgba(255,255,255,0.04)]",
                isAr && "direction-rtl"
              )}
            >
              {STATS.map((stat, i) => (
