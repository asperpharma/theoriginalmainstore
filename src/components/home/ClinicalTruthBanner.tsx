      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-polished-gold/20">
          {pillars.map((pillar, i) => (
            ...
            >
              {/* Gold seal icon */}
              <div className="neu-raised w-16 h-16 rounded-full border border-polished-gold/40 flex items-center justify-center mb-5 bg-burgundy group-hover:bg-polished-gold/10 transition-colors duration-500">
