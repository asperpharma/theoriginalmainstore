        ...
        >
          <img
            ...
            className="h-10 md:h-12 w-auto object-contain opacity-[0.65] grayscale-0
                       ...
                       will-change-transform transition-all duration-400 ease-luxury"
            loading="lazy"
          />
        </Link>
      ))}
  ...
  return (
    <section
      className="relative py-10 md:py-14 bg-background overflow-hidden
                 border-b border-foreground/5 transition-all duration-400"
    >
      {/* Header — font switches with locale */}
      <div className="text-center mb-8">
        <p
          className={cn(
            "text-[10px] md:text-[11px] uppercase tracking-[0.35em] text-accent transition-all duration-400",
