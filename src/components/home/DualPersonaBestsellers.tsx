  ...
  return (
    <div className="relative">
      ...
      <div className="hidden md:flex absolute -top-14 right-0 gap-2 z-10">
        <button
          onClick={() => scroll("left")}
          className="neu-flat w-9 h-9 rounded-full border border-accent/30 hover:border-accent flex items-center justify-center text-foreground hover:text-accent transition-all duration-300"
          aria-label="Previous"
        >
        ...
        {products.map((p) => (
          ...
          >
            <div className="relative">
              ...
              <div className="neu-raised relative aspect-[4/5] overflow-hidden mb-4 bg-card">
                <img
                  src={p.image_url || "/editorial-showcase-2.webp"}
                  alt={p.title}
                  className="h-full w-full object-contain group-hover:scale-105 transition-transform duration-500 ease-luxury-out"
                  loading="lazy"
                />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex items-center justify-center gap-4 mb-10">
          <button
            ...
            className={cn(
              "group flex items-center gap-2.5 px-6 py-3 border transition-all duration-400 ease-luxury-out",
              activePersona === "dr_sami"
                ? "neu-inset border-accent bg-accent/5 text-primary"
                : "neu-flat border-border text-muted-foreground hover:border-accent/50 hover:text-foreground"
            )}
          >
        ...
        <div className="flex items-center justify-center gap-1 mb-12 flex-wrap">
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                "px-5 py-2 font-body text-[11px] uppercase tracking-[0.15em] transition-all duration-400 ease-luxury-out border-b-2",
                activeTab === tab.key
        ...
        <div className="text-center mt-12">
          <Link
            ...
            className="inline-block font-body text-[11px] uppercase tracking-[0.3em] text-foreground
                       ...
                       transition-colors duration-400 ease-luxury-out"
          >
