        ...
        <AnimatedSection animation="fade-up">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-24 items-center">
            ...
            <div className="lg:col-span-3 relative group">
              <div className="neu-raised relative overflow-hidden aspect-[4/5] lg:aspect-[3/4] border-2 border-transparent group-hover:border-polished-gold/60 transition-all duration-700" style={{ transitionTimingFunction: 'cubic-bezier(0.19, 1, 0.22, 1)' }}>
                <img
                  src={alchemistHero}
