        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-14">
          {AMBITIONS.map((ambition) => (
            <button
              ...
              className={cn(
                "flex items-center gap-1.5 px-4 py-2 font-body text-[11px] uppercase tracking-[0.1em] border transition-all duration-400 ease-luxury-out rounded-sm",
                activeConcern === ambition.key
                  ? "neu-inset border-accent bg-accent/10 text-accent font-bold"
                  : "neu-flat border-border/50 text-muted-foreground hover:border-accent/40 hover:text-foreground"
              )}
            >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-1 flex flex-col justify-center">
              <div className="neu-raised bg-card border border-polished-gold/20 p-8 md:p-10 relative">
                {/* Gold accent top */}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
                {matchedProducts.map((p) => (
                  <Link
                    ...
                    className="group"
                  >
                    <div className="relative aspect-[4/5] overflow-hidden bg-card mb-3 border border-transparent group-hover:border-accent/30 transition-all duration-400">
                      {/* Shimmer */}
                      ...
                      <img
                        ...
                        alt={p.title}
                        className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500 ease-luxury-out"
                        loading="lazy"
                      />
                    </div>
