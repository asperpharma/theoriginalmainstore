        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-14">
          {AMBITIONS.map((ambition) => (
            <button
              ...
              className={cn(
                "flex items-center gap-1.5 px-4 py-2 font-body text-[11px] uppercase tracking-[0.1em] border transition-all duration-[400ms] ease-[cubic-bezier(0.19,1,0.22,1)] rounded-sm",
