      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          >
            ...
            {isAr ? "اختيار الصيدلاني" : "PHARMACIST'S CHOICE"}
          </Badge>
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">
            {isAr ? <>أفضل <span className="text-primary">الاختيارات</span></> : <>Top <span className="text-primary">Picks</span></>}
          </h2>
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto font-body">
            {isAr ? "منتخبة يدوياً من صيادلتنا للفعالية والسلامة والنتائج السريرية." : "Hand-selected by our pharmacists for efficacy, safety, and clinical results."}
          </p>
        </div>
