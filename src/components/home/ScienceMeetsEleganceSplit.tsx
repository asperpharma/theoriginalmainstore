      ...
      <div className="hidden md:grid grid-cols-2 min-h-[70vh]">
        ...
        >
          <div
            className="absolute inset-0 bg-cover bg-center opacity-[0.06] group-hover:opacity-[0.12] group-hover:scale-[1.02]
                        transition-all duration-800 ease-luxury-out"
            style={{
              backgroundImage:
          ...
          >
            ...
            <span className="inline-flex items-center gap-2 font-body text-[11px] uppercase tracking-[0.3em] text-primary-foreground bg-primary px-6 py-3 group-hover:bg-burgundy-dark transition-all duration-400">
        ...
        >
          ...
          >
            ...
            <span className="inline-flex items-center gap-2 font-body text-[11px] uppercase tracking-[0.3em] text-primary bg-accent px-6 py-3 group-hover:bg-polished-gold-light transition-all duration-400">
