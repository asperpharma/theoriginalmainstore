            ...
            <motion.div
              ...
              <Link
                ...
                <motion.img
                  src={brand.logo}
                  alt={`${brand.name} logo`}
                  className="w-48 md:w-56 lg:w-72 h-auto object-contain grayscale opacity-30 group-hover/logo:grayscale-0 group-hover/logo:opacity-100 will-change-transform transition-all duration-500 ease-luxury-out drop-shadow-lg"
