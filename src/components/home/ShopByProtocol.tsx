    ...
    <section className="py-14 sm:py-20 lg:py-28 relative overflow-hidden bg-gradient-to-br from-background to-secondary/30">
      ...
      <div className="luxury-container relative z-10">
        <AnimatedSection className="text-center mb-10 sm:mb-14" animation="fade-up">
          ...
          <h2 className="section-header font-heading text-2xl sm:text-3xl lg:text-4xl text-primary font-bold">
        ...
        >
            {PROTOCOLS.map((protocol) => (
              ...
              >
                <Link
                  to={protocol.href}
                  className="neu-raised group relative aspect-[4/5] sm:aspect-[4/5] overflow-hidden rounded-xl active:scale-[0.98] transition-transform block"
                ...
                >
                  <img
                    ...
                    className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-luxury-out group-hover:scale-105"
                    loading="lazy"
                  />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 z-10">
                    ...
                    <p
                      className={cn(
                        "font-body text-xs text-accent tracking-wider uppercase transition-all duration-500 ease-luxury-out",
                        "sm:overflow-hidden",
                    ...
                    <div
                      className={cn(
                        "mt-2.5 sm:mt-0 transition-all duration-500 ease-luxury-out",
                        "sm:overflow-hidden",
