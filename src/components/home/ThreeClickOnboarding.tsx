            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {STEPS[currentStep].options.map((opt) => (
                <button
                  ...
                  className="neu-raised group relative bg-asper-stone-light p-8 text-left border border-transparent hover:border-polished-gold/40 transition-all duration-500 overflow-hidden"
                >
