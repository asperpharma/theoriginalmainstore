...
const ORDER_STATUSES = [
  ...
  { value: "out_for_delivery", label: "Out for Delivery", color: "bg-sky-100 text-sky-800"        },
...
export default function AdminOrders() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchOrders stable, run when isAdmin changes
  }, [isAdmin]);
      ...
      <body>
        ...
        <div class="info-section">
          <div class="info-block">
            ...
            ${order.area ? `<p>${escapeHtml(order.area)}</p>` : ""}
