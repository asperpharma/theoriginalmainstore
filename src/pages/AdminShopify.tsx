...
const WEBHOOK_FUNCTION_URL = import.meta.env.VITE_SUPABASE_URL + "/functions/v1/shopify-webhooks";
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="text-xs"
            >
              <Webhook className="h-3.5 w-3.5 mr-1.5" /> All connections
            </Button>
            <a
              href="https://admin.shopify.com/store/lovable-project-milns"
              target="_blank"
