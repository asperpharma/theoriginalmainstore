...
export default function AsperIntelligence() {
  usePageMeta({
    title: "Asper Intelligence | Asper Beauty Shop",
    description: "AI-powered skin analysis and product intelligence — powered by Asper's clinical pharmacist team.",
    canonical: "/asper-intelligence",
  });
