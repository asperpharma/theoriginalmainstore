...
const FEATURED_BRANDS = [
  {
    ...
    icon: Droplets,
    color: "from-polished-gold/15 to-polished-gold/5",
    iconColor: "text-polished-gold",
    borderColor: "border-polished-gold/30",
    href: "/brands/vichy",
    productCount: 13,
    featured: true,
  },
  {
    ...
    icon: Heart,
    color: "from-burgundy/10 to-burgundy/5",
  ...
  },
  {
    ...
    icon: Sparkles,
    color: "from-polished-gold/10 to-polished-gold/5",
    iconColor: "text-polished-gold",
    borderColor: "border-polished-gold/20",
    href: "/collections/skin-care",
    productCount: 1,
    featured: false,
  },
  {
    ...
    icon: Sun,
    color: "from-asper-ink/10 to-asper-ink/5",
    iconColor: "text-asper-ink",
    borderColor: "border-asper-ink/20",
    href: "/collections/skin-care",
    productCount: 2,
    featured: false,
  },
            ...
            return (
              ...
              >
                <div
                  ...
                  hover:scale-[1.02] hover:shadow-2xl hover:shadow-polished-gold/15
                `}
                >
