...
<<<<<<< Updated upstream
  const notFoundTitle = isRtl ? "المجموعة غير موجودة" : "Collection Not Found";
  const notFoundDescription = isRtl
    ? "المجموعة التي تبحث عنها غير موجودة."
    : "The collection you're looking for doesn't exist.";
  const title = category ? (isRtl ? category.titleAr : category.title) : notFoundTitle;
=======
  const title = category ? (isRtl ? category.titleAr : category.title) : (isRtl ? "المجموعة غير موجودة" : "Collection Not Found");
>>>>>>> Stashed changes
  const description = category ? (isRtl ? category.descriptionAr : category.description) : "";

  usePageMeta({
    title: `${title} | ${isRtl ? "أسبر بيوتي شوب" : "Asper Beauty Shop"}`,
    description,
