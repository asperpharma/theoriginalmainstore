...
export default function Collections() {
  ...
  usePageMeta({
    title: isAr ? "المجموعات | أسبر بيوتي شوب" : "Collections | Asper Beauty Shop",
    description: isAr
      ? "تصفح مجموعاتنا المنسقة من منتجات العناية بالبشرة والشعر والجسم"
      : "Browse our curated collections of skincare, haircare, and body care products.",
