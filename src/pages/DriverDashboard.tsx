...
export default function DriverDashboard() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchOrders stable, run when user/navigate change
  }, [user, navigate]);
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="flex border-b mx-4">
        <button
          ...
          className={`flex-1 py-3 text-center font-medium transition-colors ${activeTab === "active"
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge
                      className={`${statusConfig[order.status]?.color || "bg-gray-500"
                        } text-white`}
                    >
            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex items-center justify-between">
                  ...
                  <Badge
                    className={`${statusConfig[selectedOrder.status]?.color || "bg-gray-500"
                      } text-white`}
                  >
