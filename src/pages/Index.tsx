...
const MsZainConcierge = lazy(() =>
  import("@/components/home/MsZainConcierge").then((m) => ({
    default: m.MsZainConcierge,
  }))
);
const DrSamiDisclaimer = lazy(() =>
  import("@/components/home/DrSamiDisclaimer").then((m) => ({
    default: m.DrSamiDisclaimer,
  }))
);
...
const Index = () => {
  ...
  usePageMeta({
    ...
    description: "Discover 6,500+ premium skincare, haircare and beauty products curated by pharmacists in Amman, Jordan. Vichy, CeraVe, La Roche-Posay, Eucerin & more.",
    canonical: "/",
    type: "website",
    jsonLd: {
  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main>
        ...
        {/* ═══ Ms. Zain Beauty Concierge — Elite Product Curation ═══ */}
        <Suspense fallback={<SectionSkeleton height="h-[600px]" />}>
          <MsZainConcierge />
        </Suspense>
