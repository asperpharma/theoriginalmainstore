...
const Philosophy = () => {
  ...
  usePageMeta({
    title: isArabic ? "فلسفتنا | أسبر بيوتي شوب" : "Our Philosophy | Asper Beauty Shop",
    description: isArabic
      ? "تعرف على فلسفة أسبر في الجمال الراقي المدعوم بالعلم وخبرة الصيدلة السريرية"
      : "Discover Asper's philosophy of science-backed luxury beauty, rooted in clinical pharmacy expertise.",
