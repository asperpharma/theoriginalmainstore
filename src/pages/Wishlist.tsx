              ...
              <>
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute top-3 right-3 w-10 h-10 rounded-full bg-background/80 backdrop-blur-sm border border-gold/30 flex items-center justify-center text-foreground hover:bg-red-500/20 hover:border-red-500/50 hover:text-red-400 transition-all duration-300"
                          >
                        ...
                        <div className="p-4">
                          <Link
                            to={`/product/${product.node.handle}`}
                            className="font-display text-sm text-foreground hover:text-gold transition-colors line-clamp-2 mb-2 block"
                          >
                ...
                <div className="text-center mt-12">
                  <Link to="/collections">
                    <Button
                      variant="outline"
                       className="border-gold/30 text-foreground hover:bg-gold/10 hover:border-gold font-display tracking-wider"
                    >
