...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    ...
    <Preview>Welcome to Asper Beauty Shop — Verify your email</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>Welcome to the Clinic</Heading>
          <Text style={text}>
            Thank you for joining{' '}
            <Link href={siteUrl} style={link}><strong>Asper Beauty Shop</strong></Link>
            — where science meets skincare.
          </Text>
          <Text style={text}>
            Please confirm your email address (
            <Link href={`mailto:${recipient}`} style={link}>{recipient}</Link>
            ) to unlock personalized consultations with Dr. Sami and access your curated regimens.
          </Text>
