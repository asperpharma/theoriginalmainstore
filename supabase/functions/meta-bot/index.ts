...
if (!VERIFY_TOKEN || !PAGE_ACCESS_TOKEN || !WA_PHONE_ID) {
  throw new Error("Missing required environment variables: META_VERIFY_TOKEN, META_PAGE_ACCESS_TOKEN, WHATSAPP_PHONE_NUMBER_ID");
}
