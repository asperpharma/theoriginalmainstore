...
async function handleInventoryLevelEvent(
  ...
  try {
    ...
    const itemRes = await fetch(
      `https://lovable-project-milns.myshopify.com/admin/api/2025-07/inventory_items/${inventoryItemId}.json`,
    ...
    const variantRes = await fetch(
      `https://lovable-project-milns.myshopify.com/admin/api/2025-07/variants.json?fields=id,product_id,inventory_quantity&limit=1`,
      { headers: { "X-Shopify-Access-Token": SHOPIFY_ACCESS_TOKEN } },
    );
    ...
    const prodSearchRes = await fetch(
      `https://lovable-project-milns.myshopify.com/admin/api/2025-07/products.json?limit=250&fields=id,handle,variants`,
      { headers: { "X-Shopify-Access-Token": SHOPIFY_ACCESS_TOKEN } },
    );
