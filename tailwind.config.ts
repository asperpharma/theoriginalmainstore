    ...
    theme: {
          ...
          extend: {
                  ...
                  backgroundImage: {
                            ...
                            "gold-shimmer":
                                        "linear-gradient(45deg, #D4AF37, #F3E5AB, #D4AF37)",
                  },
                  boxShadow: {
                            "maroon-glow":
                            ...
                            "neu-raised":
                                        "8px 8px 16px hsl(0 0% 85% / 0.6), -8px -8px 16px hsl(0 0% 100% / 0.8)",
                            "neu-raised-lg":
                                        "12px 12px 24px hsl(0 0% 82% / 0.7), -12px -12px 24px hsl(0 0% 100% / 0.9)",
                            "neu-inset":
                                        "inset 4px 4px 8px hsl(0 0% 85% / 0.5), inset -4px -4px 8px hsl(0 0% 100% / 0.8)",
                            "neu-flat":
                                        "4px 4px 8px hsl(0 0% 87% / 0.5), -4px -4px 8px hsl(0 0% 100% / 0.7)",
                  },
                  transitionDuration: {
                            "400": "400ms",
                            "500": "500ms",
